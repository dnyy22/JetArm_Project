...
if __name__ == "__main__":
    ...
    running = True
    if test:
        PLUGIN_LIBRARY = "/home/ubuntu/ros2_ws/src/my_arm_control/my_arm_control/libmyplugins.so"
        engine_file_path = "/home/ubuntu/ros2_ws/src/my_arm_control/my_arm_control/best.engine"

        ctypes.CDLL(PLUGIN_LIBRARY)

        # load DOTAV 1.5 labels

        categories = ["weldboard_s","weldboard_l","al_plane_s","al_plane_m","al_plane_l"]
